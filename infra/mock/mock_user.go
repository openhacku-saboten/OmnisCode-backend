...
func (_mr *MockUserMockRecorder) DoInTx(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "DoInTx", reflect.TypeOf((*MockUser)(nil).DoInTx), arg0, arg1)
}
