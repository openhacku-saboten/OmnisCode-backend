...
func (_m *MockPost) Delete(ctx context.Context, post *entity.Post) error {
	ret := _m.ctrl.Call(_m, "Delete", ctx, post)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete
func (_mr *MockPostMockRecorder) Delete(arg0, arg1 interface{}) *gomock.Call {
	return _mr.mock.ctrl.RecordCallWithMethodType(_mr.mock, "Delete", reflect.TypeOf((*MockPost)(nil).Delete), arg0, arg1)
}
