...
func TestComment_IsValid(t *testing.T) {
	tests := []struct {
		...
		{
			name: "TypeがnoneなのにFirstLineが空でなかったらエラー",
			comment: &Comment{
				ID:        1,
				UserID:    "user-id",
				PostID:    1,
		...
		{
			name: "TypeがhighlightなのにCodeが空でなかったらエラー",
			comment: &Comment{
				ID:      1,
				UserID:  "user-id",
				PostID:  1,
		...
		{
			name: "TypeがcommitなのにFirstLineが空でなかったらエラー",
			comment: &Comment{
				ID:        1,
				UserID:    "user-id",
				PostID:    1,
		...
		{
			name: "Typeがnonoe,highlight,commitでなかったらエラー",
			comment: &Comment{
				ID:      1,
				UserID:  "user-id",
				PostID:  1,
